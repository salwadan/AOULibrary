...
class Homepage extends StatefulWidget {
  ...
  Homepage({Key? key, this.isGuest = false}) : super(key: key); // Constructor to initialize the isGuest flag.

  @override
  State<Homepage> createState() => _HomepageState(); // Links the state to the widget.
}
...
class _HomepageState extends State<Homepage> {
  ...
  List titles = ["Courses", "Graduation Projects", "Internship", "Chat"];   // List of titles for grid items.
  List<Widget> classes = [ 
    Faculty(),
    Graduationprojects(),
    Internship(),
  ...
  List<Widget> bottomClasses = [Homepage(), SettingsPage()]; // List of pages for the BottomNavigationBar.
  ...
  void showCustomDialog(String title, String content) {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(title),
          content: SingleChildScrollView( // Ensures content is scrollable if long.
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar( // Top app bar.
        title: AutoSizeText( // Resizable text.
          'Home',
          ...
          IconButton(
              ...
              onPressed: () async {
                ...
                Navigator.of(context)
                    .pushNamedAndRemoveUntil("login", (route) => false);  // Redirects to login.
              },
              icon: const Icon(Icons.exit_to_app), iconSize: screenWiidth >= 700? 40 : 25,)
        ],
      ),
            ...
            children: [
              Row( // Header of the drawer.
                children: [
                  ...
                  Expanded(
                    child: ListTile(
                      title: AutoSizeText('AOU Library', presetFontSizes: [screenWiidth >= 700? 35 : 25,],),
                    ),
                  )
                ],
              ),
              ...
              ListTile(
                title: AutoSizeText('About us', presetFontSizes: [screenWiidth >= 700? 30 : 20,],),
                leading: Icon(Icons.diversity_1, size: screenWiidth >= 700? 30 : 20,),
                onTap: () {
              ...
              ListTile(
                title: AutoSizeText('Terms and Privacy', presetFontSizes: [screenWiidth >= 700? 30 : 20],),
                leading: Icon(Icons.privacy_tip, size: screenWiidth >= 700? 30 : 20,),
                onTap: () {
              ...
              Divider(
                ...
                height: 10,
                 ...
                 // Settings menu item.
              ListTile(
                title: AutoSizeText('Setting', presetFontSizes: [screenWiidth >= 700? 30 : 20], ),
                leading: Icon(Icons.settings, size: screenWiidth >= 700? 30 : 20,),
                onTap: () {
                  Navigator.of(context).push(
      ...
      body: SingleChildScrollView(   // Main body containing a grid view.
        child: Container(
          height: screenHeight,
          width: screenWiidth,
          padding: EdgeInsets.symmetric(vertical: 15),
          child: GridView.builder( // Dynamically creates the grid.
              ...
              itemBuilder: (
                ...
                return InkWell( // Wraps the item for tap detection.
                  onTap: () {
                  ...
                  child: Container( // Grid item container.
                      width: screenWiidth,
                      ...
                      child: LayoutBuilder(builder: (context, constrains) {
                        ...
                        return Column(  // Contents of each grid item.
                          mainAxisAlignment: MainAxisAlignment.spaceAround,
                          children: [
                            Container(  // Image in the grid item.
                            ...
                            Container( // Title under the image.
                              width: localWidth,
