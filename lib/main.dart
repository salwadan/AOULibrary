      ...
      theme: ThemeData(
        appBarTheme: AppBarTheme(
          centerTitle: true, // Centers AppBar title
            ...
            iconTheme: IconThemeData(color:  const Color.fromARGB(255, 37, 55, 187))),  // Icon color in AppBar
...
// A custom widget representing a stateful home page
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    super.initState(); // Ensures the parent class's initState is also called
  }
